// PersonView.java
package cz.spsmb.ctvrtak.d_maturitni_okruhy.l_navrhove_vzory.a_mvc_mvp.mvp.view;
...
/***
 * Pohled se reprezentuje vlastní vzhled aplikace. Obstarává zobrazení dat z modelu.
 */
public class PersonView extends GridPane {
	// v případě aktivního MVP (to je tento příklad) pohled musí vědět o modelu kvůli bindování. Jinak by data obstaral
	// z presenteru.
